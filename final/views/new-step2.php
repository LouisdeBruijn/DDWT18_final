            ...
            <form action="/DDWT18/final/add" method="POST" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                    <div class="<script>focus_label(InputStreetnumber)</script>">
                        ...
                        <input aria-describedby="" class="form-control" id="InputStreetnumber" placeholder="27" value="<?php if (isset($streetnumber)){echo $streetnumber;} ?>" name="streetnumber" type="number" required>
                        <div class="valid-feedback">
                            Looks good.
                        </div>
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    <div class="<script>focus_label(InputCity)</script>">
                        ...
                        <input aria-describedby="" class="form-control" id="InputCity" placeholder="City" value="<?php if (isset($city)){echo $city;} ?>" name="city" type="text" required>
                        <div class="valid-feedback">
                            Looks good.
                        </div>
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    <div class="<script>focus_label(InputStreet)</script>">
                        ...
                        <input aria-describedby="" class="form-control" id="InputStreet" placeholder="Street" value="<?php if (isset($street)){echo $street;} ?>" name="street" type="text" required>
                        <div class="valid-feedback">
                            Looks good.
                        </div>
                        <div class="invalid-feedback">
