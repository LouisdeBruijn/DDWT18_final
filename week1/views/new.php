            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" class="form-control" id="inputAbstract" name="abstract" required><?php if (isset($series_info)){echo $series_info['abstract'];} ?></textarea>
                        </div>
                    </div>
                        <input type="hidden" id="serie_id" name="serie_id" value="<?php if (isset($series_info)){echo $series_info['id'];} ?>">
